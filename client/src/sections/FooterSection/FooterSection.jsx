		...
		<div id="footer" className={styles.section_container}>
			<div className={styles.image_container}>
				<a href="https://www.instagram.com/cbar16/">
					<img className={styles.image} src={instagram}></img>
				</a>
				<a href="https://www.linkedin.com/in/ckbarrett//">
					<img className={styles.image} src={linkedin}></img>
				</a>
				<a href="https://github.com/ckbarrett">
					<img className={styles.image} src={github}></img>
				</a>
				<a href="mailto:ckbarrett116@gmail.com">
					<img className={styles.image} src={email}></img>
				</a>
			</div>
			<div className={styles.text_container}>
				...
				<p className={styles.text}>
					...
					<img className={styles.small_image} src={raspberrypi}></img>
				</p>
			</div>
		</div>
	);
